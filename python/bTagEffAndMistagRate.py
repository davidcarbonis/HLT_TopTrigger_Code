...
# input files
inputFile_ttbar = TFile('Efficiecny_hists.root')
#inputFile_QCD   = TFile('exerciseII_histos_QCD.root')

# get 2D b-tag discriminator vs jet pT histograms
discrVsPt_b_ttbar    = inputFile_ttbar.Get('bTaggingEfficiency/' + bTagger + '_b')
discrVsPt_udsg_ttbar = inputFile_ttbar.Get('bTaggingEfficiency/' + bTagger + '_udsg')
