...
def main():
    ...
    # input file
    inputFile = TFile('Efficiecny_hists.root')
    ...
    for nonb in nonbs:
        ...
        for t, bTagger in enumerate(bTaggers):
            ...
            discrVsPt_b    = inputFile.Get('bTaggingEfficiency/' + bTagger + '_b')
            discrVsPt_nonb = inputFile.Get('bTaggingEfficiency/' + bTagger + '_' + nonb)
