...
process.bTaggingEfficiency = cms.EDAnalyzer('BTaggingEfficiency',
    ...
    jets = cms.InputTag('ak8GenJets'), # input jet collection name - miniAODSim uses 'slimmedJets'
    TriggerEventTag = cms.untracked.InputTag("hltTriggerSummaryAOD", "", "HLT"),
    PathName = cms.untracked.string("HLT_Ele27_eta2p1_WP75_Gsf_CentralPFJet30_BTagCSV07_v1"), #HLT_Mu17_Mu8_v
	#HLT_Ele27_eta2p1_WP75_Gsf_CentralPFJet30_BTagCSV07_v1, HLT_IsoMu20_eta2p1_CentralPFJet30_BTagCSV07_v1
...
## Let it run
process.p = cms.Path(process.bTaggingEfficiency)
