...
// 
/**\class BTaggingReader BTaggingReaderHLT.cc Demo/DemoAnalyser/src/BTaggingReaderHLT.cc
...
class BTaggingReaderHLT : public edm::EDAnalyzer 
{
public:
  explicit BTaggingReaderHLT(const edm::ParameterSet&);
  ~BTaggingReaderHLT();
...
//
BTaggingReaderHLT::BTaggingReaderHLT(const edm::ParameterSet& iConfig) :
...
BTaggingReaderHLT::~BTaggingReaderHLT()
{
...
bool BTaggingReaderHLT::triggerfired(const edm::Event& iEvent, edm::Handle<edm::TriggerResults> triggerResultsHandle_, TString trigname){
...
bool BTaggingReaderHLT::triggerfound(const edm::Event& iEvent, edm::Handle<edm::TriggerResults> triggerResultsHandle_, TString trigname){
  const edm::TriggerNames TrigNames_ = iEvent.triggerNames(*triggerResultsHandle_);
  const unsigned int ntrigs = triggerResultsHandle_->size();
  for (unsigned int itr=0; itr<ntrigs; itr++){
    TString trigName=TrigNames_.triggerName(itr);
...
unsigned int BTaggingReaderHLT::triggerIndex(const edm::Event& iEvent, edm::Handle<edm::TriggerResults> triggerResultsHandle_, TString trigname){
  const edm::TriggerNames TrigNames_ = iEvent.triggerNames(*triggerResultsHandle_);
  const unsigned int ntrigs = triggerResultsHandle_->size();
  unsigned int itr;
...
void
BTaggingReaderHLT::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  counter++;
...
void 
BTaggingReaderHLT::beginJob()
{
}

// ------------ method called once each job just after ending the event loop  ------------
void 
BTaggingReaderHLT::endJob() 
{
}
...
/*
void 
BTaggingReaderHLT::beginRun(edm::Run const&, edm::EventSetup const&)
{
}
*/
...
/*
void 
BTaggingReaderHLT::endRun(edm::Run const&, edm::EventSetup const&)
{
}
*/
...
/*
void 
BTaggingReaderHLT::beginLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
*/
...
/*
void 
BTaggingReaderHLT::std::endluminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
*/
...
void
BTaggingReaderHLT::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(BTaggingReaderHLT);
